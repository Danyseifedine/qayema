                                ...
                                <label for="image" 
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="mb-2 text-sm text-gray-500">
                                            <span class="font-semibold">{{ __('menu_owner.common.upload_click') }}</span> {{ __('menu_owner.common.upload_or_drag') }}
                                        </p>
                                        <p class="text-xs text-gray-500">{{ __('menu_owner.common.upload_formats') }}</p>
                                    </div>
