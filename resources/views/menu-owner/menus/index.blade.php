                    ...
                    <form method="POST" action="{{ route('menu-owner.menus.store-or-update') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                                :value="old('slug', $menu?->slug)" placeholder="menu-url-slug" pattern="[a-z0-9]+(?:-[a-z0-9]+)*" />
                            <p class="mt-1 text-sm text-gray-500">Leave empty to auto-generate from menu name. Used in
                                the menu URL.</p>
