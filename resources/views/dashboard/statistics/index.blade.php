<x-sidebar-layout>
    ...
    <div class="sbl-content">
        <div class="sbl-page-head">
            <h1 class="sbl-page-title">{{ __('menu_owner.statistics.title') }}</h1>
        </div>
        <div class="space-y-6">
            @if (!$restaurant)
                <div class="qp-card">
                    <div class="p-6 text-gray-900">
                        ...
                        <x-btn href="{{ route('menu-owner.restaurant.index') }}" variant="primary" size="sm" class="mt-4">
                    ...
                    <div class="qp-card">
                        <div class="qp-card-body">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">{{ __('menu_owner.statistics.whatsapp_orders') }}</p>
                                    <p class="text-xs text-gray-500 mt-0.5">{{ __('menu_owner.statistics.whatsapp_orders_desc') }}</p>
                                    <p class="text-2xl font-semibold text-gray-900 mt-1">{{ number_format($whatsappOrders) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
